...
public class ZstdDirectBufferCompressingStream implements Closeable, Flushable {
    ...
    public ZstdDirectBufferCompressingStream(@NotNull ByteBuffer target, int level) throws IOException {
    ...
    public synchronized @NotNull ZstdDirectBufferCompressingStream setDict(byte @NotNull [] dict) throws IOException {
        inner.setDict(dict);
        return this;
    }

    public synchronized @NotNull ZstdDirectBufferCompressingStream setDict(@NotNull ZstdDictCompress dict) throws IOException {
        inner.setDict(dict);
        return this;
    }
    ...
    public synchronized void compress(@NotNull ByteBuffer source) throws IOException {
