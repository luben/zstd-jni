...
/**
 * InputStreamBase filter that decompresses the data provided
...
class ZstdInputStreamBase<T extends ZstdInputStreamBase<T>> extends FilterInputStream {
     ...
     */
    protected ZstdInputStreamBase(InputStream inStream) throws IOException {
     ...
     */
    protected ZstdInputStreamBase(InputStream inStream, BufferPool bufferPool) throws IOException {
        super(inStream);
