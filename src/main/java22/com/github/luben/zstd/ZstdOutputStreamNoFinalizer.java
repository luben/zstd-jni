...
public class ZstdOutputStreamNoFinalizer extends FilterOutputStream {
    ...
    private final @NotNull MemorySegment dstPos = ZstdBinding.sizeTSlot(dstPosArray);
    private final @NotNull MemorySegment srcPos = ZstdBinding.sizeTSlot(srcPosArray);
