 ...
 */
class ZstdOutputStreamBase<T extends ZstdOutputStreamBase<T>> extends FilterOutputStream {
     ...
     */
    protected ZstdOutputStreamBase(OutputStream outStream, int level) throws IOException {
     ...
     * @param outStream the stream to wrap
     */
    protected ZstdOutputStreamBase(OutputStream outStream) throws IOException {
        this(outStream, NoPool.INSTANCE);
    }
     ...
     */
    protected ZstdOutputStreamBase(OutputStream outStream, BufferPool bufferPool, int level) throws IOException {
     ...
     * @param bufferPool the pool to fetch and return buffers
     */
    protected ZstdOutputStreamBase(OutputStream outStream, BufferPool bufferPool) throws IOException {
        super(outStream);
