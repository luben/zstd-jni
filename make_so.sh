...
compile () {
    ...
    ssh $HOST 'export PATH=$HOME/bin:$PATH; '$CC' -shared -static-libgcc -flto -DDYNAMIC_BMI2=0 -fPIC -O3 -DZSTD_LEGACY_SUPPORT=4 -DZSTD_MULTITHREAD=1 -I/usr/include -I./jni -I./native -I./native/common -I./native/legacy -std=c99 -lpthread -o libzstd-jni.so native/*.c native/legacy/*.c native/common/*.c native/compress/*.c native/decompress/*.c native/dictBuilder/*.c'
    mkdir -p $INSTALL
...
compile amd64   linux
compile i386    linux "gcc -march=i586"
compile ppc64   linux
